        ...
        <div className="banner-container" ref={containerRef} style={{ willChange: 'transform' }}>
          <p className="phrase flex" ref={phraseRef} style={{ height: "500px" }}>
            {Array.from({ length: 20 }).map((_, index) => (
              ...
              >
               ECCLECTION 👩‍🎤 LOCAL ART 🎨 COMMUNITY VIBES 🏳️‍🌈 GIFT SHOP 🎁 Funky Tees 🎨 Mixed Media Art 🎨 Wellness Goods 🧖‍♀️Candles 🕯️ Jewelry 💍 Accessories 👜 Home Goods 🪑 Vintage Oddities 🪄 Handmade Goods 🧶 Creativivty 🎨
              </span>
            ))}
          </p>
        </div>
