...
export function Intro() {
  return (
    <section className="relative min-h-screen  text-primary-foreground overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 md:py-32">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 max-w-7xl mx-auto">
          ...
          <div className="flex-1">
            ...
            {/* Main headline */}
            <h2 className="text-5xl font-brand md:text-7xl lg:text-8xl font-black leading-normal mb-8 md:mb-12 text-balance">
              WE
              <br />
              ARE
              <br />
            ...
            <div className="max-w-2xl mb-12 md:mb-16">
              <p className="text-lg md:text-2xl leading-relaxed text-primary-foreground/90">
                ...
                self-expression through fashion, activities, clothing and arts
              </p>
            </div>
            ...
            <div className="mt-20 md:mt-32 pt-8 border-t border-primary-foreground/20">
              <p className="text-xl md:text-base font-brand tracking-widest uppercase text-primary-foreground/70">
