  ...
  return (
    <section className={`container section-pad ${className}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Contact Information */}
        <Card className="p-8 bg-cyan-600 text-black">
          ...
          <div className="space-y-4">
            {contactInfo.phone && (
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <a href={`tel:${contactInfo.phone}`} className="text-black hover:underline">
                    {contactInfo.phone}
                  </a>
                </div>
              </div>
            ...
            {contactInfo.hours && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="font-medium text-black font-brand">Hours</p>
                  <p className="text-black">{contactInfo.hours}</p>
                </div>
              </div>
            )}
          </div>
