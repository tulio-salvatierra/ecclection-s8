  ...
  return (
    <section ref={ref} className="w-full h-auto py-24 border-t-2 border-b-2 border-black bg-black/30 backdrop-blur-2xl">
      <div className="fade-in sm:w-3/4 mx-auto p-8">
        <h2 className="fade-in font-brand text-4xl mb-3 text-white">
          About our artwork & AI
        </h2>

        <p className="fade-in text-xl md:text-base text-white mb-3">
        ...
        <p className="fade-in text-xl md:text-base text-white mb-6">
