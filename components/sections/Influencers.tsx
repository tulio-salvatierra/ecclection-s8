      ...
      <div className=" text-[#111111] h-auto w-full px-4">
        ...
        <div className=" sm:mt-5 h-full grid grid-cols-1 md:grid-cols-2 items-start justify-between gap-10">
          ...
          <div className="flex flex-col justify-center">
            <p className="fade-in text-xl sm:text-3xl font-brand text-white leading-snug p-1">
            ...
            <p className="fade-in text-lg sm:text-2xl font-secondary text-white mb-8 leading-snug p-1">
