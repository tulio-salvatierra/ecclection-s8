...
export function Footer() {
  return (
    <footer className="bg-black/50 text-primary-foreground">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* Navigation Links */}
          <div>
            <h3 className="mb-4 text-lg font-semibold font-brand">Navigation</h3>
          ...
          {/* Store Hours */}
          <div>
            <h3 className="mb-4 text-lg font-semibold font-brand">Store Hours</h3>
        ...
        <div className="mt-12 border-t border-primary-foreground/20 pt-6 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Ecclection</p>
          <p>Made By <a href="https://cicerowebstudio.xyz">Cicero Web Studio</a></p>
        </div>
      </div>
    </footer>
  )
